function timestamps = importIntanTime(time_file_name, filedir)
...
fclose(fid); 
timestamps = timestamps / 30000; %frequency_parameters.amplifier_sample_rate; % sample rate from header file ; % this number comes from sample rate from 
