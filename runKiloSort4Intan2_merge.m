function runKiloSort4Intan2_merge
...
[ops,savePath] = mergeIntanOFPCSystem3_merge2(savePath, intanpath); %%% the input savePath is the parent folder where all kilosort data folders (experiment specific) are
