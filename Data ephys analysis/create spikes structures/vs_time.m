function vs_timepoints = vs_time(time_file_name, analog_file_name, filedir) %maybe instead take the filename and raw data dir path as input and call other functions inside
