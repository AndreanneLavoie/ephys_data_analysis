function intan_info=read_Intan_RHD2000_file_ana(file, path)
...
% save data
intan_info.amplifier_channels=amplifier_channels;
intan_info.board_adc_channels=board_adc_channels;
intan_info.frequency_parameters=frequency_parameters;
intan_info.spike_triggers=spike_triggers;
intan_info.notes=notes;
